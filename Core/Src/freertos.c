...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(Remote_TaskHand, Remote_Task, osPriorityNormal, 0, 128);
  Remote_TaskHandHandle = osThreadCreate(osThread(Remote_TaskHand), NULL);

  /* definition and creation of Chassis_TaskHan */
  osThreadDef(Chassis_TaskHan, Chassis_Task, osPriorityIdle, 0, 128);
